...
const Projects = () => {
  ...
  return (
    ...
    initial= {{opacity:0, x:-200}}
      ...
      viewport={{once:true}}
    className='container mx-auto py-4 pt-40 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Space, Building Legacies-Explore Our Projects</p>
      {/* Slider buttons */}
            ...
            <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
              ...
              <div className='absolute left-0 right-0 bottom-5 flex justify-center'>
                ...
                <p className='text-gray-500 text-sm'>
                  {project.price}<span className='px-1h'>|</span>{project.location}
                </p>
                </div>
              </div>
            </div>
